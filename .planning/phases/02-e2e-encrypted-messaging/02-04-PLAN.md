...
export const useCryptoStore = create<CryptoState>((set, get) => ({
  ...
  getOrDeriveSessionKeys: async (userId: string, contactId: string, contactPublicKey: string) => {
    ...
    // Determine who is "initiator" (lower userId lexicographically)
    const isInitiator = userId < contactId;
...
NOTE: Session keys are cached per contact. The isInitiator flag ensures both parties derive the same key pair directions.
  </action>
